...
(function (ns) {
    ns.wrapper = function (goog, fb) {
        ...
        fb.core.ServerActions = goog.defineClass(null, {
            ...
            auth: goog.abstractMethod,
            unauth: goog.abstractMethod,
        ...
        fb.core.util.ImmutableTree = goog.defineClass(null, {
            constructor: function (value, opt_children) {
                ...
                EmptyChildren_: new fb.core.util.SortedMap(fb.core.util.stringCompare), fromObject: function (obj) {
        ...
        fb.login.transports.CordovaInAppBrowser.prototype.open = function (url, params, cb) {
            ...
            windowRef.addEventListener("loadstart", function (e) {
                ...
                var requestInfo = new fb.login.RequestInfo(null, null, {
                    "requestId": self.requestId_,
                    "requestKey": reqKey
                });
        ...
        fb.login.AuthenticationManager.prototype.finishOAuthRedirectLogin_ = function () {
            ...
            if (redirectRequestId) {
                ...
                var transports = [fb.login.transports.XHR, fb.login.transports.JSONP], serverParams = {
                    "requestId": redirectRequestId,
                    "requestKey": fb.login.transports.util.extractRedirectCompletionHash(document.location.hash)
                }, transportOptions = {}, requestInfo = new fb.login.RequestInfo(clientOptions, transportOptions, serverParams);
        ...
        fb.realtime.Constants = {
            PROTOCOL_VERSION: "5",
            VERSION_PARAM: "v",
            TRANSPORT_SESSION_PARAM: "s",
            REFERER_PARAM: "r",
            FORGE_REF: "f",
            FORGE_DOMAIN: "firebaseio.com",
